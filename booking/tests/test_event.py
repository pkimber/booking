...
class TestEvent(TestCase):
    ...
    def test_public_delete(self):
        ...
        BookingFactory(
            title='b', start_date=one, start_time=start, deleted=True,
        )
